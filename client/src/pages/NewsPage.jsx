              ...
              <div className={`backdrop-blur-xl rounded-[2.5rem] p-8 md:p-12 shadow-2xl border transition-colors duration-300 ${theme === 'dark'
                ...
                >
                  <div className="relative">
                    <label className={`block font-semibold mb-3 ${theme === 'dark' ? 'text-gray-100' : 'text-gray-800'
                      }`}>
          ...
          <section data-aos="fade-up" className="py-16 px-4">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {/* Tip 1 */}
                <div data-aos="fade-left" className={`rounded-3xl p-8 shadow-xl border hover:shadow-2xl transition duration-300 ${theme === 'dark'
                ...
                {/* Tip 2 */}
                <div data-aos="fade-up" className={`rounded-3xl p-8 shadow-xl border hover:shadow-2xl transition duration-300 ${theme === 'dark'
                    ? 'bg-gray-800 border-gray-700'
                ...
                {/* Tip 3 */}
                <div data-aos="fade-right" className={`rounded-3xl p-8 shadow-xl border hover:shadow-2xl transition duration-300 ${theme === 'dark'
                    ? 'bg-gray-800 border-gray-700'
