...
const steps = [
  {
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
        <rect x="5" y="8" width="30" height="24" rx="4" fill="#60a5fa" fillOpacity="0.13"/>
  ...
  },
  {
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
        <rect x="8" y="10" width="24" height="20" rx="4" fill="#a78bfa" fillOpacity="0.13"/>
  ...
  },
  {
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
        <rect x="8" y="10" width="24" height="20" rx="4" fill="#60a5fa" fillOpacity="0.10"/>
...
const HowItWorks = () => {
  ...
  return (
    <section
      className="max-w-9xl mx-auto px-4 py-16"
      style={{
    ...
    >
      <h2
        className="text-2xl md:text-3xl font-extrabold mb-10 text-center tracking-tight"
        style={{ color: `var(--heading, ${currentColors['--heading']})` }}
      >
        How It Works
      </h2>
      <div className="flex flex-col md:flex-row gap-8 justify-center items-center relative">
        ...
        {steps.map((s, i) => (
          <div
            key={s.title}
            className={`flex-1 backdrop-blur-lg rounded-2xl shadow-xl p-8 text-center border relative z-10 transition-all duration-300 ease-in-out group ${
          ...
          >
            ...
            <p
              className=""
              style={{ color: `var(--body-text, ${currentColors['--body-text']})` }}
            >
              {s.desc}
            </p>
            {i < steps.length - 1 && (
