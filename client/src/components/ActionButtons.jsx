  ...
  return (
    <div className="bg-slate-900/50 backdrop-blur-lg border border-white/5 rounded-lg p-4 shadow-md">
      ...
      <div className="flex flex-col gap-3">
        <button className="flex items-center justify-center gap-2 bg-gradient-to-r from-purple-500 to-indigo-500 text-white font-medium py-2.5 px-4 rounded-md hover:opacity-90 transition transform hover:-translate-y-0.5">
